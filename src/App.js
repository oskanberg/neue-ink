...
const defaultContent = md.deserialize(`
Call me Ishmael.
=======
...
export default class App extends React.Component {
    ...
    load = () => {
        ...
        loaded = loaded.map(({ name, content, ...other }) => ({
            name: md.deserialize(name),
            content: md.deserialize(content),
            ...other
        }));
    ...
    store = () => {
        let serialised = this.state.files
            .map(({ name, content, ...other }) => ({
                name: md.serialize(name),
                content: md.serialize(content),
                ...other
            }));
